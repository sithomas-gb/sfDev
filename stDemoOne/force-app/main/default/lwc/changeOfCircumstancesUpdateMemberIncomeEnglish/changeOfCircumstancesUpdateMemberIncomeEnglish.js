...
import { OMNIDEF } from './changeOfCircumstancesUpdateMemberIncomeEnglish_def.js';
import tmpl from './changeOfCircumstancesUpdateMemberIncomeEnglish.html';
import tmpl_nds from './changeOfCircumstancesUpdateMemberIncomeEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class changeOfCircumstancesUpdateMemberIncomeEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
