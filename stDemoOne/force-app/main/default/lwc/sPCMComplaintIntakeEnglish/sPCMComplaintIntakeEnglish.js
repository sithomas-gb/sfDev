...
import { OMNIDEF } from './sPCMComplaintIntakeEnglish_def.js';
import tmpl from './sPCMComplaintIntakeEnglish.html';
import tmpl_nds from './sPCMComplaintIntakeEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class sPCMComplaintIntakeEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
