...
import { OMNIDEF } from './changeOfCircumstancesUpdateHouseHoldMemberDetailsEnglish_def.js';
import tmpl from './changeOfCircumstancesUpdateHouseHoldMemberDetailsEnglish.html';
import tmpl_nds from './changeOfCircumstancesUpdateHouseHoldMemberDetailsEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class changeOfCircumstancesUpdateHouseHoldMemberDetailsEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
