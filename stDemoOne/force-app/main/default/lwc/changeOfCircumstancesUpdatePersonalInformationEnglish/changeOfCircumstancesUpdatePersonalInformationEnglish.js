...
import { OMNIDEF } from './changeOfCircumstancesUpdatePersonalInformationEnglish_def.js';
import tmpl from './changeOfCircumstancesUpdatePersonalInformationEnglish.html';
import tmpl_nds from './changeOfCircumstancesUpdatePersonalInformationEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class changeOfCircumstancesUpdatePersonalInformationEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
