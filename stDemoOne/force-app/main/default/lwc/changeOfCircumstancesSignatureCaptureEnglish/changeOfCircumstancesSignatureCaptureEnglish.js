...
import { OMNIDEF } from './changeOfCircumstancesSignatureCaptureEnglish_def.js';
import tmpl from './changeOfCircumstancesSignatureCaptureEnglish.html';
import tmpl_nds from './changeOfCircumstancesSignatureCaptureEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class changeOfCircumstancesSignatureCaptureEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
