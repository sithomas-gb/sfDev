...
import { OMNIDEF } from './changeOfCircumstancesApplicationSubmissionConfirmationEnglish_def.js';
import tmpl from './changeOfCircumstancesApplicationSubmissionConfirmationEnglish.html';
import tmpl_nds from './changeOfCircumstancesApplicationSubmissionConfirmationEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class changeOfCircumstancesApplicationSubmissionConfirmationEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
