...
import { OMNIDEF } from './benefitManagementCheckEligibilityAndAssignBenefitEnglish_def.js';
import tmpl from './benefitManagementCheckEligibilityAndAssignBenefitEnglish.html';
import tmpl_nds from './benefitManagementCheckEligibilityAndAssignBenefitEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class benefitManagementCheckEligibilityAndAssignBenefitEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
