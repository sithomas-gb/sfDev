...
import { OMNIDEF } from './changeOfCircumstancesApplicationSubmissionEnglish_def.js';
import tmpl from './changeOfCircumstancesApplicationSubmissionEnglish.html';
import tmpl_nds from './changeOfCircumstancesApplicationSubmissionEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class changeOfCircumstancesApplicationSubmissionEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
