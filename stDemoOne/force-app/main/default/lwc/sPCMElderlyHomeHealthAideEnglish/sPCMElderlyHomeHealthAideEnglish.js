...
import { OMNIDEF } from './sPCMElderlyHomeHealthAideEnglish_def.js';
import tmpl from './sPCMElderlyHomeHealthAideEnglish.html';
import tmpl_nds from './sPCMElderlyHomeHealthAideEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class sPCMElderlyHomeHealthAideEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
