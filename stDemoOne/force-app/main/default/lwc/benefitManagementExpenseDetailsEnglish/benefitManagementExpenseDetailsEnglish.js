...
import { OMNIDEF } from './benefitManagementExpenseDetailsEnglish_def.js';
import tmpl from './benefitManagementExpenseDetailsEnglish.html';
import tmpl_nds from './benefitManagementExpenseDetailsEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class benefitManagementExpenseDetailsEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
