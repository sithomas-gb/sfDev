...
import { OMNIDEF } from './elderlyCareAssessmentEnglish_def.js';
import tmpl from './elderlyCareAssessmentEnglish.html';
import tmpl_nds from './elderlyCareAssessmentEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class elderlyCareAssessmentEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
