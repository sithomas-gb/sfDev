...
import { OMNIDEF } from './changeOfCircumstancesReportChangeTypeEnglish_def.js';
import tmpl from './changeOfCircumstancesReportChangeTypeEnglish.html';
import tmpl_nds from './changeOfCircumstancesReportChangeTypeEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class changeOfCircumstancesReportChangeTypeEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
