...
import { OMNIDEF } from './grantsAFAFProjectOverviewEnglish_def.js';
import tmpl from './grantsAFAFProjectOverviewEnglish.html';
import tmpl_nds from './grantsAFAFProjectOverviewEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class grantsAFAFProjectOverviewEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
